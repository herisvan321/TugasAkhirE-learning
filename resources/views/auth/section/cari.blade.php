...
<label style="color:#000">jumlah group yang ditemukan : {{@count($cari)}}</label>
	...
	@php($cu = DB::table('gabung_groups')->where('id_group',$c->id_group)->where('noinduk',$id_user)->first())
		<a href="{{url('/homeadmin/view/masuk/group/'.$c->slug)}}" class="w3-right w3-button w3-white w3-border w3-border-red w3-round-large">Masuk</a>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-inline my-2 my-lg-0 mr-lg-2" action="{{url('/homeauth/proses/id_group')}}" method="post">
