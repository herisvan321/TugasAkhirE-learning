...
<body class="fixed-nav sticky-footer bg-primary" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark atas fixed-top" id="mainNav">
    ...
    @include('mahasiswa.include.menukiri')
    @include('mahasiswa.include.menuatas')
    </div>
  </nav>
  ...
  <footer class="sticky-footer">
    <div class="container">
      <div class="text-center">
        <small style="color:#000">Copyright &copy; 2018 Herisvan Hendra</small>
      </div>
    </div>
  </footer>
...
@include('mahasiswa.section.modal.modalcari')
@include('mahasiswa.section.modal.modalcariuser')
