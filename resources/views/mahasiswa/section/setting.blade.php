...
<div class="row">
	<div class="col-sm-6">
		<h5 class="w3-padding w3-light-gray w3-round w3-animate-left">
		<label>Update Biodata</label> <hr>
			<form action="{{url('/homemahasiswa/proses/setting/update')}}" method="post">{{csrf_field()}}
	...
	<div class="col-sm-6">
		<div class="col-sm-12">
			<h5 class="w3-padding w3-light-gray w3-round w3-animate-right">
				<form action="{{url('/homemahasiswa/proses/setting/update')}}" method="post">{{csrf_field()}}
		...
		<div class="col-sm-12">
			<h5 class="w3-padding w3-light-gray w3-round w3-animate-bottom">
		<label>Update Foto</label> <hr>
				<form action="{{url('/homemahasiswa/proses/setting/update')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
				<input type="hidden" value="{{$user->id}}" name="id" >
					{{csrf_field()}}
					<div class="form-group">
